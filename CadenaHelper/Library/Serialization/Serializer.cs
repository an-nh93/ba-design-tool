...
namespace Cadena.Library.Serialization
{
    public class Serializer
    {
        ...
        {
            var type = itemType ?? (sourceProperty == null || sourceProperty.PropertyType == typeof(System.Object) ? source.GetType() : sourceProperty.PropertyType);
            ...
            else if (type.IsEnumerable())
            {
                ...
                node = createElement(null).WithChildren(source.AsXmlEnumerable().Select(x =>
