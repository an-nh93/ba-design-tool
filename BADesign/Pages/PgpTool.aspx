...
<head runat="server">
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ba-sidebar { width: 240px; background: var(--bg-darker); border-right: 1px solid var(--border); padding: 1.5rem 0; flex-shrink: 0; position: fixed; left: 0; top: 0; bottom: 0; z-index: 1000; overflow-y: auto; }
        ...
        <div class="ba-container">
            <aside class="ba-sidebar">
                ...
                <nav class="ba-nav">
                    ...
                    <a href="#" class="ba-nav-item active">PGP Tool</a>
                </nav>
            </aside>
            <main class="ba-main">
