...
BEGIN
    ...
    (N'DatabaseManageServers', N'Database Manage Servers', N'Quản lý cấu hình server: thêm, sửa, xóa server trong Database Tools; thấy tất cả server. Dùng cho manager.');
